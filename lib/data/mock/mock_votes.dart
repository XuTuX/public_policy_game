  ...
  static List<VoteModel> _generateVotesForBill(
    ...
    return memberVotes.entries.map((entry) {
      ...
      return VoteModel(
        ...
        status: switch (entry.value) {
          VoteType.yes => MemberVoteStatus.yes,
          VoteType.no => MemberVoteStatus.no,
          VoteType.abstain => MemberVoteStatus.abstain,
        },
        rawVoteResult: entry.value.label,
      );
    }).toList();
  }
}
